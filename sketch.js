...
G2=new Ground(1300,350,300,20);
 ...
 B1 = new Box(550,350,50,50);
 B2 = new Box(600,350,50,50);
 B3 = new Box(650,350,50,50);
 B4 = new Box(700,350,50,50);
 B5 = new Box(750,350,50,50);
 B6 = new Box(800,350,50,50);
 B7 = new Box(850,350,50,50);


 B10 = new Box(600,300,50,50);
 B11 = new Box(650,300,50,50);
 B12 = new Box(700,300,50,50);
 B13 = new Box(750,300,50,50);
 B14 = new Box(800,300,50,50);

 B15 = new Box(650,250,50,50);
 B16 = new Box(700,250,50,50);
 B17 = new Box(750,250,50,50);

 B18 = new Box(700,200,50,50);
